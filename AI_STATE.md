...
- **Bloqueios:** nova revisão se entrar contexto externo; acesso a artefato oficial Kokoro ou decisão por outro fornecedor; depois licença/artefato/custo e aceitação longa de TTS antes da geração integral; nenhum asset foi ainda pesquisado/baixado; aprovação final/publicação continuam pendentes.
